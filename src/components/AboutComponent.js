...
/**
 * This functional component renders the leader details using Media
 * @param leader: leader object containing all the information related to leader
 * @returns {*}:  renders the leader information using the reactstrap <Media> component
 * @constructor
 */
...
/**
 * This is exported About component containing all the information
 * @param props: properties passed while calling this component
 * @returns {*}
 * @constructor
 */
